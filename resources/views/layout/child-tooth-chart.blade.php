<div class="tooth-chart">
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <g class="toothLabels">
            <text id="lblT" transform="matrix(1 0 0 1 109.31 423.6409)" font-family="'Avenir-Heavy'"
                font-size="24px">T</text>
            <text id="lblS" transform="matrix(1 0 0 1 126.7426 490.0023)" font-family="'Avenir-Heavy'"
                font-size="24px">S</text>
            <text id="lblR" transform="matrix(1 0 0 1 146.5064 533.043)" font-family="'Avenir-Heavy'"
                font-size="24px">R</text>
            <text id="lblQ" transform="matrix(1 0 0 1 168.0594 560.1663)" font-family="'Avenir-Heavy'"
                font-size="21px">Q</text>
            <text id="lblP" transform="matrix(1 0 0 1 201.0274 564.6503)" font-family="'Avenir-Heavy'"
                font-size="21px">P</text>
            <text id="lblO" transform="matrix(1 0 0 1 229.0002 564.6497)" font-family="'Avenir-Heavy'"
                font-size="21px">O</text>
            <text id="lblN" transform="matrix(1 0 0 1 261.966 560.167)" font-family="'Avenir-Heavy'"
                font-size="21px">N</text>
            <text id="lblM" transform="matrix(1 0 0 1 274.6497 533.0432)" font-family="'Avenir-Heavy'"
                font-size="24px">M</text>
            <text id="lblL" transform="matrix(1 0 0 1 301.4584 490.002)" font-family="'Avenir-Heavy'"
                font-size="24px">L</text>
            <text id="lblK" transform="matrix(1 0 0 1 318.6671 423.6405)" font-family="'Avenir-Heavy'"
                font-size="24px">K</text>
            <text id="lblJ" transform="matrix(1 0 0 1 326.1867 278.9355)" font-family="'Avenir-Heavy'"
                font-size="24px">J</text>
            <text id="lblI" transform="matrix(1 0 0 1 308.6669 224.1667)" font-family="'Avenir-Heavy'"
                font-size="24px">I</text>
            <text id="lblH" transform="matrix(1 0 0 1 280.8936 185.2723)" font-family="'Avenir-Heavy'"
                font-size="24px">H</text>
            <text id="lblG" transform="matrix(1 0 0 1 256.5099 157.1388)" font-family="'Avenir-Heavy'"
                font-size="24px">G</text>
            <text id="lblF" transform="matrix(1 0 0 1 230.6667 151.667)" font-family="'Avenir-Heavy'"
                font-size="24px">F</text>
            <text id="lblE" transform="matrix(1 0 0 1 196.0272 151.6668)" font-family="'Avenir-Heavy'"
                font-size="24px">E</text>
            <text id="lblD" transform="matrix(1 0 0 1 166.0594 157.1387)" font-family="'Avenir-Heavy'"
                font-size="24px">D</text>
            <text id="lblC" transform="matrix(1 0 0 1 147.1964 185.2724)" font-family="'Avenir-Heavy'"
                font-size="24px">C</text>
            <text id="lblB" transform="matrix(1 0 0 1 121.5838 224.1666)" font-family="'Avenir-Heavy'"
                font-size="24px">B</text>
            <text id="lblA" transform="matrix(1 0 0 1 109.31 278.9357)" font-family="'Avenir-Heavy'"
                font-size="24px">A</text>
        </g>
        <g class="dtfmLabels">
            <text id="txtToothT" transform="matrix(1 0 0 1 1.0001 447.0915)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothS" transform="matrix(1 0 0 1 23.3102 506.416)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothR" transform="matrix(1 0 0 1 57.4898 569.9049)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothQ" transform="matrix(1 0 0 1 109.3098 618.5447)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothP" transform="matrix(1 0 0 1 173.8689 642.0117)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothO" transform="matrix(1 0 0 1 236.6671 642.012)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothN" transform="matrix(1 0 0 1 300.104 618.5447)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothM" transform="matrix(1 0 0 1 358.7073 569.905)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothL" transform="matrix(1 0 0 1 393.2542 506.4159)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothK" transform="matrix(1 0 0 1 405.3402 447.0916)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothJ" transform="matrix(1 0 0 1 411.0546 240.9981)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothI" transform="matrix(1 0 0 1 390.5584 186.7916)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothH" transform="matrix(1 0 0 1 362.0746 133.1618)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothG" transform="matrix(1 0 0 1 314.9963 97.0455)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothF" transform="matrix(1 0 0 1 236.6669 69.3723)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothE" transform="matrix(1 0 0 1 173.869 69.3719)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothD" transform="matrix(1 0 0 1 111.8719 90.5134)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothC" transform="matrix(1 0 0 1 59.4649 141.1669)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothB" transform="matrix(1 0 0 1 25.25 184.2726)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
            <text id="txtToothA" transform="matrix(1 0 0 1 7.6667 247.2726)" font-family="'MyriadPro-Regular'"
                font-size="16px">DFM</text>
        </g>
        <g class="spots">
            <polygon id="ToothT" fill="#FFFFFF" data-key="T"
                points="65.7,373.5 74,375.2 82,380.8 86.3,384.8 90.3,390.2 92.7,395.8 93,404.8 93,416.8
            ...
            <polygon id="ToothS" fill="#FFFFFF" data-key="S"
                points="93.7,456.2 82.7,455.8 70.7,460.8 66.3,467.2 63.7,474.2 62,487.2 63.3,500.2
            ...
            <polygon id="ToothR" fill="#FFFFFF" data-key="R"
                points="129.3,532.2 137,535.2 142.7,541.2 146,548.8 147.7,557.8 144.7,565.2 136.7,570.5
            123,573.8 113,574.2 105,572.8 101.3,564.8 103,551.2 107.3,541.2 111.3,535.5 124,531.5 	" />
            <polygon id="ToothQ" fill="#FFFFFF" data-key="Q"
                points="164.3,564.5 168.3,568.8 173,592.2 172,598.2 169.3,601.8 162,601.8 152,599.8
            142.3,595.5 131,586.8 130.7,584.5 135,575.8 140.3,570.2 149.7,564.5 159,562.8 	" />
            <polygon id="ToothP" fill="#FFFFFF" data-key="P"
                points="208,576.5 218,607.2 214,611.5 206.7,613.2 191,612.8 179,606.8 172.3,601.5
            174,597.8 190.3,578.2 199.7,571.8 205.7,573.8 	" />
            <polygon id="ToothO" fill="#FFFFFF" data-key="O"
                points="244.3,574.2 235.7,575.2 230.7,581.8 225.7,593.5 221.7,604.5 220.3,609.8 224,613.5
            234.3,615.5 248.7,613.8 258.7,610.8 264,606.2 265.3,598.8 	" />
            <polygon id="ToothN" fill="#FFFFFF" data-key="N"
                points="306.3,575.8 298.7,569.2 289.7,566.2 280.7,564.2 275.3,566.8 272,572.2 268.7,583.8
            267.3,593.2 266.3,599.2 266.7,603.8 270.7,607.8 276.3,608.8 286.7,605.2 300,597.5 307.7,590.5 309,583.5 	" />
            <polygon id="ToothM" fill="#FFFFFF" data-key="M"
                points="335,532.2 341.7,546.5 343.3,562.8 339.7,570.5 331.7,573.5 309,572.5 302,569.2
            298,564.5 299.7,548.2 303,539.5 307.3,531.8 315.3,525.2 321.3,525.2 325,525.5 	" />
            <polygon id="ToothL" fill="#FFFFFF" data-key="L"
                points="354,450.2 365.7,453.8 377,459.5 384.3,469.2 385,481.5 382.7,491.8 369.7,517.8
            357.3,527.8 340.7,532.2 331.7,528.5 324.3,523.5 321,515.2 320.7,504.2 325.3,489.5 330.3,470.2 335,460.5 343.7,453.2 	" />
            <polygon id="ToothK" fill="#FFFFFF" data-key="K"
                points="391.7,370.2 379,367.8 366.7,370.2 356.3,378.8 350.3,388.2 347.7,396.2 348,411.5
            ...
            <polygon id="ToothJ" fill="#FFFFFF" data-key="J"
                points="384.3,231.2 391.3,232.5 402.3,241.5 409,253.8 414.3,267.2 416,281.8 413.7,300.2
            ...
            <polygon id="ToothI" fill="#FFFFFF" data-key="I"
                points="359.3,167.2 367.3,169.8 375.3,182.5 384,199.8 389.7,211.8 389.3,220.5 386,227.5
            377.3,233.5 363.3,238.5 355.3,237.5 348.3,233.2 343.3,224.8 337,211.5 330.7,195.8 328,186.8 332.7,175.2 342.7,168.5 	" />
            <polygon id="ToothH" fill="#FFFFFF" data-key="H"
                points="305.7,136.5 303,143.8 301,150.5 304,161.5 313,170.2 323,172.8 331.7,172.5
            339.3,168.8 346,162.5 350.3,152.2 351.3,141.2 347.3,134.5 343,132.2 334,131.5 322.3,130.2 316,129.8 	" />
            <polygon id="ToothG" fill="#FFFFFF" data-key="G"
                points="277.3,98.8 276.7,107.2 276,119.2 276,129.5 279.7,138.2 285.7,141.2 293.3,141.5
            301.7,135.8 316.7,126.8 320,122.5 320,116.2 316.3,109.8 301.7,101.8 294.7,98.8 282,97.5 	" />
            <polygon id="ToothF" fill="#FFFFFF" data-key="F"
                points="222,87.5 222.7,93.8 226.7,98.2 231,107.8 236.7,121.5 242,125.8 248,126.8 257,120.2
            275.3,101.5 276,95.2 273.7,92.2 266,85.8 248.7,80.5 236.3,80.2 229,81.8 	" />
            <polygon id="ToothE" fill="#FFFFFF" data-key="E"
                points="168.3,94.5 172,103.5 175.3,107.5 184,120.5 190.3,127.5 198.7,128.5 203.3,124.8
            209.7,115.2 219.7,92.5 218.7,85.8 209,83.8 191.3,82.5 182,84.2 173.7,88.2 	" />
            <polygon id="ToothD" fill="#FFFFFF" data-key="D"
                points="123.7,124.2 131.3,131.2 143.3,137.5 151.3,141.8 159,142.5 165.7,137.5 169.3,125.8
            169,108.8 169.7,100.2 165,95.5 158.3,95.2 145.7,97.8 138.7,102.5 130,108.2 124.3,114.2 	" />
            <polygon id="ToothC" fill="#FFFFFF" data-key="C"
                points="106.7,132.2 118,132.2 130.3,132.5 139.7,138.2 144.7,147.8 144.7,160.8 134.3,173.8
            121.7,180.2 115,180.2 107.7,174.5 100,169.8 98.7,156.8 97.3,147.8 98.3,138.8 104.7,133.2 	" />
            <polygon id="ToothB" fill="#FFFFFF" data-key="B"
                points="90.2,242.2 97.3,236.1 106.3,224.2 114.9,200.1 117.3,189.4 113,179.1 95.7,169.8
            86.2,169.8 71.9,179.1 63.5,191.3 58.6,202.5 54,215.2 55.8,227.2 65.8,238.9 79.1,242.2 	" />
            <polygon id="ToothA" fill="#FFFFFF" data-key="A"
                points="55.2,236.1 60,237.2 69.8,240.2 86.9,243.3 92,247 95.7,255.8 95.7,271.2 94.7,286.5
        ...
        <g id="child-outlines">
            <g id="XMLID_9_">
                ...
                <path id="XMLID_136_" fill="#010101"
                    d="M361.4,216.8l0.5-0.8c2.1-0.5,2-4.2-0.1-4.6C360.5,212.9,360.4,215.2,361.4,216.8z" />
                ...
                <path id="XMLID_71_" fill="#010101"
                    d="M372.2,251.4c1.3,2.2,2.7,4.5,3.1,7.1c0.4,2.6-0.3,5.5-2.4,7c0,1.3,2.2,1.1,2.9,0
