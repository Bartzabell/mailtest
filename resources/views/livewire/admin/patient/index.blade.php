<div class="flex flex-col min-h-screen">
    ...
    <div class="ml-12">
        <div class="m-3">
            {{-- Add Button --}}
            <x-button class="text-white rounded-lg shadow-lg bg-gradient-to-r from-blue-700 via-blue to-blue-300 hover:text-black hover:scale-105" icon="plus" label="A D D" href="{{ route('patient.create') }}" target="_self"/>
        </div>
        <div class="m-5">
            <livewire:table.patient-table />
            </div>
    </div>
