<div>
    ...
    <div class="relative md:min-h-[20px] md:h-16 bottom-0 left-0 right-0 flex flex-row p-4 md:bg-white mb-8">
        ...
        <h1 class="relative z-10 ml-3 text-xl font-semibold tracking-tight text-gray-700">Edit Services</h1>
        <div class="absolute inset-0 shadow-lg"></div>
    </div>
    <div class="w-2/3 p-5 m-auto mt-10 h-3/4 min-w-[500px]">

        <x-card title="Edit Service" rounded="3xl">
            ...
            <div class="flex gap-x-5">
                ...
                <x-inputs.number class="p-2" label="Minutes Take" wire:model='duration' />
