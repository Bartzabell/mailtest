<div class="flex flex-col min-h-screen">
    ...
    <div class="relative md:min-h-[20px] md:h-16 bottom-0 left-0 right-0 flex flex-row p-4 md:bg-white mb-8">
        ...
        <h1 class="relative z-10 ml-3 text-xl font-semibold tracking-tight text-gray-700">Services</h1>
    ...
    <div class="m-3">
        {{-- Add Button --}}
        <div class="mb-3">
            {{-- <a class="px-3 py-2 text-black border-2 border-black rounded-lg mr-7" label="Services" href="{{ route('services.index') }}" target="_self">View Services</a>
            <a class="px-3 py-2 text-black border-2 border-black rounded-lg mr-7" label="Discounts" href="{{ route('services.discounts') }}" target="_self">View Discounts</a> --}}
        ...
        icon="plus" label="ADD" href="{{ route('services.create') }}" target="_self"/>
    </div>
    <div class="m-5">
        <livewire:table.services-table />
    </div>
    </div>
