<div class="fixed inset-0 flex items-end overflow-y-auto sm:pt-16 justify-center {{ $align }} {{ $zIndex }}"
    ...
    <div class="w-full p-4 transition-all sm:max-w-lg"
        x-show="show"
        x-transition:enter="ease-out duration-300"
        ...
        <div class="relative p-4 space-y-4 bg-white shadow-md dark:bg-secondary-800 rounded-xl"
            ...
            <div class="grid grid-cols-1 gap-y-2 sm:gap-x-3 rounded-b-xl"
                ...
                <div x-show="dialog && dialog.accept" class="text-white rounded-lg bg-gradient-to-r from-blue-700 via-blue to-blue-300 hover:text-black hover:scale-105 sm:order-last" x-ref="accept"></div>
                <div x-show="dialog && dialog.reject" class="text-black bg-white border-2 border-blue-500 rounded-lg hover:scale-105" x-ref="reject"></div>
            </div>
