<div {{ $attributes->only(['class', 'wire:key'])->class('relative w-full') }}
    ...
    <div class="relative">
        ...
        >
            <x-slot name="prepend">
                <div :class="{
                    ...
                    <template x-if="!config.multiselect">
                        <div @class([
                                'absolute left-0 inset-y-0 w-[calc(100%-0.5rem)] flex items-center bg-white border-2 rounded-lg border-gray-200',
                                'pl-2.5' =>  $icon,
                                'pl-3.5' => !$icon,
                            ])
                            x-on:click="toggle">
                    ...
                    <template x-if="config.multiselect">
                        <div class="absolute inset-y-0 left-0 flex items-center w-full pl-3 overflow-hidden bg-white border-2 border-gray-200 rounded-lg pr-14" x-on:click="toggle">
            ...
            <x-slot name="append">
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 bg-white border-t-2 border-b-2 border-r-2 border-gray-200 gap-x-2">
